...
export default function ListDataEmployeeResign() {
  ...
  useEffect(() => {
    axios
      .get(`/user/data-employee-resign?_page=${currentPage}`)
      .then((res) => {
  ...
  return (
    <>
      <HeaderMainMessage text={t("inconponentListDataEmployeeResign")} />
